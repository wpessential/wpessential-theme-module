...
final class Setup
{
	...
	public static function setup_actions ()
	{
		$action_list = apply_filters( 'wpe/theme/after_setup/hooks', [
				'Support'       => [
						'callback' => [ 'WPEssential\Plugins\Theme\Support', 'constructor' ],
						'priority' => 10
				],
				'Sidebars'      => [
						'callback' => [ 'WPEssential\Plugins\Theme\Sidebars', 'constructor' ],
						'priority' => 20
				],
				'Widgets'       => [
						'callback' => [ 'WPEssential\Plugins\Theme\Widgets', 'constructor' ],
						'priority' => 30
				],
				'Images'        => [
						'callback' => [ 'WPEssential\Plugins\Theme\Images', 'constructor' ],
						'priority' => 40
				],
				'Menus'         => [
						'callback' => [ 'WPEssential\Plugins\Theme\Menus', 'constructor' ],
						'priority' => 50
				],
				'Tgm'           => [
