...
<div id="comments" class="wpe-comments-area <?php echo apply_filters( 'wpe/comment/area/classes', 'comments-area' ); ?>">
	<?php if ( have_comments() ) : ?><?php do_action( 'wpe_comment_title' ); ?><?php do_action( 'wpe_comment_list' ); ?><?php endif; ?><?php do_action( 'wpe_comments_close' ); ?><?php do_action( 'wpe_comment_form' ); ?>
</div>
